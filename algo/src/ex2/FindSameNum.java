...
/**
 * 날짜 : OOOO/OO/OO 이름 : 김철학 내용 : 알고리즘 실습 - 중복숫자 찾기
 * 
 * 개발과정 1) numbs1의 첫번째 원소 6을 뒤에 있는 3, 5, 3, 7과 차례로 비교, 6과 중복된 숫자 발견 못함. 2) 두번째
 * 원소 3을 뒤에 있는 원소 5, 3, 7과 차례로 비교, 앞에 있는 6과는 이미 비교했음, 4번째 자리 3과 중복 발견. 3) 발견된 중복
 * 숫자 3을 집합 resultSet에 저장 4) resultSet에 저장된 데이터 출력
 */
